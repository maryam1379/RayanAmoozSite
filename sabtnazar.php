...
<head>
  ...
  <link rel="stylesheet" href="fontawesome-free-5.15.1-web/css/all.css">
    <title>ثبت نظر | رایان آموز</title>
</head>
<body dir="rtl">
...
<br><br>
<p class="p-comment"> کاربر گرامی نظر شما با موفقیت ثبت شد. <br>
صمیمانه از شما تشکر میکنیم.
</p>
<a href="ertebatbama.php"><button  class="input-btn btn1" type="button"> بازگشت</button> </a>
<div  >
<img class="gif-sabtnazar"  src="pic/gif.gif" alt="">
</div>
     </div>
</main>
</div>
...
mysqli_query($con,"INSERT INTO `ertebat1` (`id`, `name`, `subject`, `text`, `date`) VALUES (NULL,'$_POST[name]','$_POST[subject]','$_POST[text]',current_timestamp())");
