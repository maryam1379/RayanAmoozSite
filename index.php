...
<head>
  ...
  <link rel="stylesheet" href="fontawesome-free-5.15.1-web/css/all.css">
    <title> صفحه اصلی | رایان آموز</title>
</head>
<body dir="rtl">
...
<div id="boxmenubar1">
    ...
    <input dir="rtl"  type="text" id="myInput"  placeholder="جستجو... " title="Type in a word">
    </div> 
...
<main>
     <!--*******************************************اسلایدرها******************************************-->
<div class="div-slid-tabligh">  
     <div class="div-slid">
        <button style="right: 2%; " class="fas fa-angle-right  btn-slid" onclick="clearInterval(timer4),btnSlidl(),clearInterval(timer2),clearInterval(timer3)"></button>   <a   id="alink1" href="form.html"> 
            <img class="linkslid" id="imgslid" src="pic/pic1.png" alt="">
            </a><button style="left: 1%;" class="fas fa-angle-left   btn-slid" onclick="clearInterval(timer3),btnSlidr(),clearInterval(timer2),clearInterval(timer4)"></button>
      </div>
...
<div class="div-aside">
    <a   id="alink" href="https://www.sarabara.com/">
        <img class="linktabligh  linktabligh1" id="imgtabligh" src="pic/1.png" alt="تبلیغات"></a>
     <a   id="alink2" href="https://www.sarabara.com/shop/?_sale=1&_per_page=48&_sort=random">
         <img style="margin-top: 10px;"  class="linktabligh   linktabligh1" id="imgtabligh1" src="pic/1.jpg" alt="تبلیغات"></a></div>
</div>    
<!--********************************************************************************************-->
<div class="div-titr" style="overflow: hidden; "><img class="img-titr" src="pic/titr1.png" alt="تیتر تازه ترین مطالب">  </div>
<div class="div-new">
    <div   class="div-box-img">
        <a class="a-new" href="linkeha.html#a8">
        <img class="img-box" src="pic/pichtml1.png" alt="تازه ترین مطالب">
        <br>
        ایجاد یک BookMark در HTML</a>
    </div>
    <div class="div-box-img">
        <a class="a-new" href="image.html#a7">
        <img class="img-box" src="pic/pichtml2.png" alt="تازه ترین مطالب">
        <br>
         تصاویر متحرک</a>
    </div>
    <div class="div-box-img">  
        <a class="a-new" href="listha.html#a7">
        <img class="img-box" src="pic/pichtml3.png" alt="تازه ترین مطالب">
        <br>
      لیست های تو در تو</a>
    </div>
    <div class="div-box-img">
        <a class="a-new" href="form.html#a12">
        <img class="img-box" src="pic/pichtml4.png" alt="تازه ترین مطالب">
        <br>
         تگ &#8249;fieldset> </a>
    </div> 
    <div  class="div-box-img"> 
        <a class="a-new" href="style.html#a7">
        <img class="img-box"src="pic/piccss1.png" alt="تازه ترین مطالب">
        <br>
      Color</a>
    </div>
    <div class="div-box-img">  <a class="a-new" href="moarefiCSS.html#a12">
        <img class="img-box" src="pic/piccss2.png" alt="تازه ترین مطالب">
        <br>
شیوه نامه‌ی درون خطی Inline Style
    </a>
    </div>
    <div class="div-box-img">
        <a class="a-new" href="amalgar.html#a6">
        <img class="img-box" src="pic/picphp1.png" alt="تازه ترین مطالب">
        <br>
       عملگرهای منطقی</a>
    </div>
    <div class="div-box-img">
        <a class="a-new" href="arayeh.html#a5">
        <img class="img-box" src="pic/picphp2.png" alt="تازه ترین مطالب">
        <br>
...
<!--****************************************************************************-->
<div id="video1" class="div-titr" style="overflow: hidden; "><img class="img-titr" src="pic/titr3.png" alt="تیتر فیلم های آموزشی">  <br> </div>
<div class="div-new">
   
    
        <div    class="div-box-img">
            <a  class="a-new" href="video.php?varname=1">
            <img class="img-box" src="pic/videoForm1.png" alt="فیلم آموزشی">
            <br>
          ساخت فرم</a>
        </div>
    <div class="div-box-img">
        <a class="a-new" href="video.php?varname=2">
        <img class="img-box" src="pic/videoForm2.jpg" alt="فیلم آموزشی">
        <br>
       ساخت button  زیبا</a>
    </div>
    <div class="div-box-img">  
        <a class="a-new" href="video.php?varname=3">
        <img class="img-box" src="pic/videoForm3.jpg" alt="فیلم آموزشی">
        <br>
    ساخت منو</a>
    </div>
    <div class="div-box-img">
        <a class="a-new" href="video.php?varname=4">
        <img class="img-box" src="pic/videoForm4.png" alt="فیلم آموزشی">
        <br>
       ساخت اسلایدشو </a>
    </div> 
...
<!-- ****************************************************************************-->
<div class="div-titr" style="overflow: hidden; "><img class="img-titr" src="pic/titr2.png" alt="تیتر کتاب های پیشنهادی"> <br></div>
<div class="div-new">
    <div  class="div-box-img"> 
        <a class="a-new" href="https://www.digikala.com/product/dkp-80099/%DA%A9%D8%AA%D8%A7%D8%A8-%D8%A2%D9%85%D9%88%D8%B2%D8%B4-css3-%D9%88-html5-%D8%A7%D8%AB%D8%B1-%D8%AD%D9%85%DB%8C%D8%AF%D8%B1%D8%B6%D8%A7-%D8%B7%D8%A7%D9%84%D8%A8%DB%8C">
        <img class="img-box"src="pic/picbook1.png" alt="کتاب های پیشنهادی">
        <br>
        کتاب آموزش CSS3 و HTML5  </a>
    </div>
    <div class="div-box-img">  <a class="a-new" href="https://www.digikala.com/product/dkp-80114/%DA%A9%D8%AA%D8%A7%D8%A8-%D8%A8%D8%B1%D9%86%D8%A7%D9%85%D9%87-%D9%86%D9%88%DB%8C%D8%B3%DB%8C-%D8%A8%D9%87-%D8%B2%D8%A8%D8%A7%D9%86-php-%D8%A7%D8%AB%D8%B1-%D8%AD%D9%85%DB%8C%D8%AF%D8%B1%D8%B6%D8%A7-%D8%B7%D8%A7%D9%84%D8%A8%DB%8C">
        <img class="img-box" src="pic/picbook2.png" alt="کتاب های پیشنهادی">
        <br>
        کتاب برنامه نویسی به زبان PHP
    </a>
    </div>
    <div class="div-box-img">
        <a class="a-new" href="https://www.digikala.com/product/dkp-2028673/%DA%A9%D8%AA%D8%A7%D8%A8-%D8%AF%D8%B3%D8%AA%DA%AF%DB%8C%D8%B1%D9%87-%D9%87%D8%A7%DB%8C-%D9%88%D8%A8-htmlcssphp-%D8%A7%D8%AB%D8%B1-%D9%85%D9%87%D9%86%D8%AF%D8%B3-%D8%B3%D8%A7%D8%B1%D8%A7-%D9%86%D8%AE%D8%B9%DB%8C">
        <img class="img-box" src="pic/picbook3.png" alt="کتاب های پیشنهادی">
        <br>
        کتاب دستگیره های وب HTML
        <br> ,CSS,PHP </a>
    </div>
    <div class="div-box-img">
        <a class="a-new" href="https://www.digikala.com/product/dkp-269374/%DA%A9%D8%AA%D8%A7%D8%A8-%D9%85%D8%B1%D8%AC%D8%B9-%DA%A9%D8%A7%D8%B1%D8%A8%D8%B1%D8%AF%DB%8C-htmlcss-%D8%A8%D8%B1%D8%A7%DB%8C-%D8%B7%D8%B1%D8%A7%D8%AD%DB%8C-%D9%88%D8%A8-%D8%B3%D8%A7%DB%8C%D8%AA-%D8%A7%D8%AB%D8%B1-%DA%A9%D8%B1%DB%8C%DA%AF-%DA%AF%D8%B1%D8%A7%D9%86%D9%84">
        <img class="img-box" src="pic/picbook4.png" alt="کتاب های پیشنهادی">
        <br>
        کتاب مرجع کاربردی HTML,CSS 
        <br> برای طراحی وب سایت   
    </a>
    </div>
</div>  
</main>
...
//**********************   بخش اسلایدر    ***************************
var j=1;
var timer2=setInterval(frome1 , 3000);
function frome1(){
   if(j==3){ j=0;}
   else{j++; document.getElementById('imgslid').src="pic/pic"+j+".png";
   if(j==1){ document.getElementById('alink1').href="form.html";}
   if(j==2){ document.getElementById('alink1').href="ghalebbandi.html#a8";}
   if(j==3){ document.getElementById('alink1').href="formPHP.html";}}
}
//دکمه های اسلایدر
var timer3;
var timer4;
function btnSlidr(){
        if(j==1){j=2;
            document.getElementById('imgslid').src="pic/pic2.png";
    document.getElementById('alink1').href="ghalebbandi.html#a8";
}
   else if(j==2){j=3;
    document.getElementById('imgslid').src="pic/pic3.png";
    document.getElementById('alink1').href="formPHP.html";
}
   else if(j==3){j=1;
    document.getElementById('imgslid').src="pic/pic1.png";
        document.getElementById('alink1').href="form.html";
    }
   timer3=setInterval(f1,3000);
 }
 function f1(){
   if(j==3){ j=0;}
   else{j++; document.getElementById('imgslid').src="pic/pic"+j+".png";
